...
st.set_page_config(
    page_title="Pokemon Black",
    page_icon="🔅"
)

st.markdown("<h1 style='text-align: center; color: grey;'>Pokemon Black</h1>", unsafe_allow_html=True)
...
if do: 
    with l3:
        res_busqueda = bus.formatear(res_busqueda, 'black')
