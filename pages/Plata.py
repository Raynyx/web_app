...
st.markdown("<h1 style='text-align: center; color: grey;'>Pokemon Silver</h1>", unsafe_allow_html=True)
...
if do: 
    with l3:
        res_busqueda = bus.formatear(res_busqueda, 'silver')
